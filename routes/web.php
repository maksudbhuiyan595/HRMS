...
Route::get('/otp-form',[CustomerController::class,'otpForm'])->name('otp.form');
Route::post('/otp-verified',[CustomerController::class,'otpVerified'])->name('otp.verified');
...
Route::get('/department/delete/{id}',[DepartmentController::class, 'destroy'])->name('department.destroy');
  ...
  Route::get('/employees/list/to-project',[ProjectController::class, 'EmployeesListToProject'])->name('employee.list.project');
    ...
    Route::get('/leavebalance/list',[leavebalance::class, 'list'])->name('balance.list');
        
        //LeaveTypeController
    Route::get('/leavetype/list',[LeaveController::class, 'list'])->name('leave.type.list');
    Route::get('/leavetype/create',[LeaveController::class, 'create'])->name('leave.type.create');
    Route::post('/leavetype/store',[LeaveController::class, 'store'])->name('leave.type.store');
    Route::get('/leavetype/view/{id}',[LeaveController::class, 'view'])->name('leave.type.view');
    Route::get('/leavetype/edit/{id}',[LeaveController::class, 'edit'])->name('leave.type.edit');
    Route::post('/leavetype/update/{id}',[LeaveController::class, 'update'])->name('leave.type.update');
